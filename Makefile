...
COMPILER_DIR := /home/viety/Tool/GNU_ARM/bin
FLASH_DIR := /home/viety/Tool/STM32prog/stlink/bin
...
FL := $(FLASH_DIR)/STM32_Programmer_CLI
...
flash: 
	$(FL) -c port=SWD -w "$(PATH_OUTPUT)/$(PROJ_NAME).hex" 0x08000000
	@echo -----------------------------flash OK-----------------------------
